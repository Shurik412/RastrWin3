...
dict_name_chart = {'Раздел 1.1': (
    ...
    'Раздел 1.2': (
        title_1_2, p_ps_one_1_2, q_ps_one_1_2, p_ps_two_1_2, q_ps_one_1_2, u_ps_one_1_2, ag_u_ps_one_1_2,
        u_ps_two_1_2, ag_u_ps_two_1_2, d_ag_1_2),
    'Раздел 2.1': (
        title_2_1, p_ps_one_2_1, q_ps_one_2_1, p_ps_two_2_1, q_ps_one_2_1, u_ps_one_2_1, ag_u_ps_one_2_1,
        u_ps_two_2_1, ag_u_ps_two_2_1, d_ag_2_1),
    'Раздел 2.2': (
        title_2_2, p_ps_one_2_2, q_ps_one_2_2, p_ps_two_2_2, q_ps_one_2_2, u_ps_one_2_2, ag_u_ps_one_2_2,
        u_ps_two_2_2, ag_u_ps_two_2_2, d_ag_2_2)}
...
if fl_1_2 == 1:
    ...
    for index, (pl_ip_scn2, t) in enumerate(pl_ip_r1_scn2):
        ws_2[f'A{index + start_row}'] = t
        ws_2[f'B{index + start_row}'] = pl_ip_scn2

    for index, (ql_ip_scn2, t) in enumerate(ql_ip_r1_scn2):
        ws_2[f'C{index + start_row}'] = ql_ip_scn2
    ...
    for index, (pl_iq_scn2, t) in enumerate(pl_iq_r1_scn2):
        ws_2[f'D{index + start_row}'] = pl_iq_scn2

    for index, (ql_iq_scn2, t) in enumerate(ql_iq_r1_scn2):
        ws_2[f'E{index + start_row}'] = ql_iq_scn2
...
if fl_graf == 1:
    ...
    for i in range(0, 4):
        ...
        chart_1 = ChartExcelOtherSheet(work_book=wb_w, work_sheet=ws_graphs, chart_obj=ch1_ScatterChart,
                                       chart_title=dict_name_chart[list_name_excel[i]][0],
                                       x_axis_title='t, c',
        ...
        chart_1.add_line_chart(work_sheet_other=ws_.title,
                               ...
                               title_ch=dict_name_chart[list_name_excel[i]][1],
                               width_line_pt=2.0)
        ...
        chart_1.add_line_chart(work_sheet_other=ws_.title,
                               ...
                               title_from_data_ch=False,
                               title_ch=dict_name_chart[list_name_excel[i]][2],
                               width_line_pt=2.0)
        ...
        chart_1.add_line_chart(work_sheet_other=ws_.title,
                               ...
                               title_from_data_ch=False,
                               title_ch=dict_name_chart[list_name_excel[i]][3],
                               width_line_pt=2.0)
        ...
        chart_1.add_line_chart(work_sheet_other=ws_.title,
                               ...
                               title_from_data_ch=False,
                               title_ch=dict_name_chart[list_name_excel[i]][4],
                               width_line_pt=2.0)

        chart_1.print_chart(cell_print_chart=list_coordinates_of_graphs[i][0])
        ...
        chart_2.add_line_chart(work_sheet_other=ws_.title,
                               ...
                               title_from_data_ch=False,
                               title_ch=dict_name_chart[list_name_excel[i]][5],
                               width_line_pt=2.0)
        ...
        chart_2.add_line_chart(work_sheet_other=ws_.title,
                               ...
                               title_from_data_ch=False,
                               title_ch=dict_name_chart[list_name_excel[i]][7],
                               width_line_pt=2.0)

        chart_2.print_chart(cell_print_chart=list_coordinates_of_graphs[i][1])
        ...
        chart_3.add_line_chart(work_sheet_other=ws_.title,
                               ...
                               title_from_data_ch=False,
                               title_ch=dict_name_chart[list_name_excel[i]][6],
                               width_line_pt=2.0)
        ...
        chart_3.add_line_chart(work_sheet_other=ws_.title,
                               ...
                               title_from_data_ch=False,
                               title_ch=dict_name_chart[list_name_excel[i]][8],
                               width_line_pt=2.0)

        chart_3.print_chart(cell_print_chart=list_coordinates_of_graphs[i][2])
        ...
        chart_4.add_line_chart(work_sheet_other=ws_.title,
                               ...
                               title_from_data_ch=False,
                               title_ch=dict_name_chart[list_name_excel[i]][9],
                               width_line_pt=2.0)

        chart_4.print_chart(cell_print_chart=list_coordinates_of_graphs[i][3])
