...
if __name__ == '__main__':
    ...
    # from RastrWin.loading.shablons_dir import shablon_file_regime
    # from RastrWin.getting.get_parameter import GettingParameter, GetTableCommonInfo
    #
    # rastr = win32com.client.Dispatch('Astra.Rastr')
    #
    # load_file(rastr_win=rastr,
    #           file_path=r'C:\Users\Ohrimenko_AG\Documents\RastrWin\test-rastr\cx195.rg2',
