...
if __name__ == '__main__':
    ...
    from RastrWin.loading.shablon import shablon_file_dynamic

    RastrWin = win32com.client.Dispatch("Astra.Rastr")
    # load_file(rastr_win=RastrWin,
    #           rg_kod=1,
    #           file_path='C:\\Users\\Ohrimenko_AG\\Documents\\RastrWin\\test-rastr\\RUSTab\\test9.rst',
    ...
    load_file = LoadRUSTab(rastr_win=RastrWin,
                           shablon=shablon_file_dynamic,
                           switch_command_line=True)
    load_file.load(file_path='C:\\Users\\Ohrimenko_AG\\Documents\\RastrWin\\test-rastr\\RUSTab\\test9.rst')
