...
from RastrWinLib.tables.tables_attributes import com_regim_table, com_dynamics_attributes_list
...
def set_regim(
    ...
    if switch_command_line is not False:
        ...
        print(f'neb_p: Точность расчета (dP) "до" = {get_nag_p}; "после" = {get_nag_p_after};\n'
