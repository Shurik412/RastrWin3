...
def set_regim(
    ...
    variable_def_rowid = VariableDefRowId(rastr_win=RASTR, table=com_regim_table,
                                          switch_command_line=switch_command_line)

    variable_def_rowid.make_changes(column=list_key[0], row_id=0, value=float(neb_p))
    variable_def_rowid.make_changes(column=list_key[1], row_id=0, value=it_max)
    variable_def_rowid.make_changes(column=list_key[2], row_id=0, value=start)
    variable_def_rowid.make_changes(column=list_key[3], row_id=0, value=flot)
    variable_def_rowid.make_changes(column=list_key[4], row_id=0, value=float(dv_min))
    variable_def_rowid.make_changes(column=list_key[5], row_id=0, value=float(dv_max))
    variable_def_rowid.make_changes(column=list_key[6], row_id=0, value=dd_max)
    variable_def_rowid.make_changes(column=list_key[7], row_id=0, value=status)
    variable_def_rowid.make_changes(column=list_key[8], row_id=0, value=rr)
    variable_def_rowid.make_changes(column=list_key[9], row_id=0, value=wt)
    variable_def_rowid.make_changes(column=list_key[10], row_id=0, value=gen_p)
    variable_def_rowid.make_changes(column=list_key[11], row_id=0, value=method)
    variable_def_rowid.make_changes(column=list_key[12], row_id=0, value=method_ogr)
    variable_def_rowid.make_changes(column=list_key[13], row_id=0, value=print_mode)
    variable_def_rowid.make_changes(column=list_key[14], row_id=0, value=qmax)
    variable_def_rowid.make_changes(column=list_key[15], row_id=0, value=min_x)
    variable_def_rowid.make_changes(column=list_key[16], row_id=0, value=calc_tr)
    variable_def_rowid.make_changes(column=list_key[17], row_id=0, value=nag_p)
    variable_def_rowid.make_changes(column=list_key[18], row_id=0, value=rem_breaker)
    variable_def_rowid.make_changes(column=list_key[19], row_id=0, value=gram)
    variable_def_rowid.make_changes(column=list_key[20], row_id=0, value=ctrl_baza)
    variable_def_rowid.make_changes(column=list_key[21], row_id=0, value=itz)
    variable_def_rowid.make_changes(column=list_key[22], row_id=0, value=itz_ogr_max)
    variable_def_rowid.make_changes(column=list_key[23], row_id=0, value=itz_ogr_min)
    variable_def_rowid.make_changes(column=list_key[24], row_id=0, value=min_nodes_in_island)
