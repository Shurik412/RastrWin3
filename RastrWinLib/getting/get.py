...
from RastrWinLib.tables.tables_attributes import com_cxema_table, com_cxema_attributes
...
if __name__ == '__main__':
    ...
    from RastrWinLib.directory_rastrwin.dir_test_rastr import file_RUSTab_9_rst
