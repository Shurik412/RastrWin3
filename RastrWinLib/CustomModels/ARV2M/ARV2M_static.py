...
# Модель автоматического регулятора возбуждения типа АРВ 2М_статика (Силмаш),
# реализованная в ПК RUSTab, состоит из следующих макроблоков:
# 1.АРВ: AVR-2M_res.xmldev;
...
class Parameters:
    ...
    Модель автоматического регулятора возбуждения типа АРВ 2М_статика (Силмаш),
    реализованная в ПК RUSTab, состоит из следующих макроблоков:
    1.	АРВ: AVR-2M_res.xmldev (таблица 52);
    2.	Релейная форсировка: AVR-2M_RF.xmldev (таблица 53).
    Параметры модели AVR-2M_res.xmldev заносятся в таблицу «АРВ (ИД)».
