# -*- coding: utf-8 -*-
# Модель автоматического регулятора возбуждения типа АРВНЛ_статика_lite,
# реализованная в ПК RUSTab, состоит из одного макроблока:
# 1. АРВ: ARVNL_sts simp.xmldev (таблица 75).
# Параметры модели ARVNL_sts simp.xmldev заносятся в таблицу «АРВ (ИД)».
