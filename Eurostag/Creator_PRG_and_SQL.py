...
#########################################################################################################
    ...
    print('Создайте файл (макрос вывода дынных по сетевым элементам) в Eurostag-e с названием файла "PRG.prg".')
    print(
        'Данный файл будет использоваться для создания копий с названиями файлов в соответствии с рассматриваемыми режимами.')
    print(
        'Пример: 1_2_N_750kV.prg - 1 - Зима макс; 2 - откл ВЛ(в соответствии со списком режмов; N (No) или Y (Yes) - без PSS и с PSS.')
    ...
    print(
        'CASE_1_EXPORT_ASCII=C:/03_LetoMaxKalinaNPP/PRG.exp   => копируем ссылку из CASE_1_NAME (выше) и выставляем с расширением *.exp')
